    ...
    @if($banyak>0)
        ...
        <div class="card mb-5">
            <div style="height:300px; width:100%; overflow:hidden;" class="d-flex align-items-center justify-content-center">
                ...
                @else
                    <img src="https://source.unsplash.com/1200x400?{{ $posts[0]->category->name }}" class="card-img-top" title="{{ $posts[0]->title }}" style="max-height:100%;max-width:100%;">
                @endif
            </div>
            ...
            <a href="/blog/post/{{ $posts[0]->slug }}" class="btn btn-primary">Readmore</a>
            </div>
        </div>
            ...
            <div class="row d-flex align-items-stretch">
                ...
                <div class="col-md-4 my-3 d-flex align-items-stretch">
                    <div class="card bg-dark text-light">
                        ...
                        <div style="height:250px; width:100%; overflow:hidden;" class="d-flex align-items-start justify-content-center">
                            @if($post->image!=null)
                                <img src="{{ asset('storage/'.$post->image) }}" class="card-img-top" title="{{ $post->title }}">
                            @else
                                <img src="https://source.unsplash.com/1280x720?{{ $post->category->name }}" class="card-img-top" title="{{ $post->title }}" style="max-height:100%;max-width:100%;height:auto;width:auto;">
                            @endif
                        </div>
                        ...
                        <div class="card-body" style="height: 250px;">
                            ...
                            <div class="readmore p-0" style="height:30%; display:flex; align-items:end; justify-content:center;">
                                <a href="/blog/post/{{ $post->slug }}" class="btn btn-primary" style="width:80%;">Readmore</a>
                            </div>
                        </div>
                    </div>
                </div>
